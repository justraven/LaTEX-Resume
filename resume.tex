...
\name{Alim Satria Fi'i}{Wijaya Kusuma}
\position{Hardware Engineer{\enskip\cdotp\enskip}PCB Designer}
\address{Sleman Regency, Yogyakarta, Indonesia}

\email{alimsatria45@outlook.com}
%\dateofbirth{January 1st, 1970}
\homepage{justraven.github.io/gitprofile} 
\github{github.com/justraven}
\linkedin{linkedin.com/in/alimsatria}
% \gitlab{gitlab-id}
